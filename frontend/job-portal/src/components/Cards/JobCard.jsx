        ...
        <div className="flex items-center justify-between">
            ...
            {!saved && (
                ...
                {job?.applicationStatus ? (
                    ...
                    !hideApply && (
                    <button
                        className="bg-gradient-to-r from-blue-50 to-blue-50 text-sm text-blue-700 hover:text-white px-6 py-2.5 rounded-xl hover:from-blue-500 hover:from-blue-600 transition-all duration-200 font-semibold transform hover:-translate-y-0.5 "
                        onClick={(e) => {
                        e.stopPropagation();
                        onApply();
                        }}
