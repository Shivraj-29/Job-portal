          ...
          <div className="bg-white p-6 rounded-lg">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="flex-1">
                    <h1 className="text-2xl lg:text-xl font-semibold mb-2 leading-tight text-gray-900">
                      {jobDetails.title}
                    </h1>
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <div className="flex items-center space-x-1 px-4 py-2 bg-gray-50 text-sm text-gray-700 rounded-full border border-gray-200">
            ...
            <div className="px-0 pb-8 space-y-8">
              ...
              <div className="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl">
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-emerald-400/10 to-emerald-400/10 rounded-full -translate-y-16 translate-x-16"></div>
                <div className="relative z-10 ">
