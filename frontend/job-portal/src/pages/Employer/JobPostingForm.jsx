          ...
          <div className="bg-white shadow-xl rounded-2xl p-6">
            ...
            <div className="space-y-6">
              ...
              <TextareaField
                ...
                helperText="Include required skills, experience level, education, and any prefered qualification"
                required
              />
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 focus:border-blue-500 disabled:bg-gray-400 disabled:cursor-not-allowed outline-none transition-colors duration-200"
                >
                  {isSubmitting ? (
                    <>
